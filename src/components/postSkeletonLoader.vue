<template>
    <div>
        <div class="flex flex-col gap-y-5">
            <div v-for="skeleton in props.noOfSkeleton" :key="skeleton" class="w-full rounded-xl border animate-pulse shadow-sm dark:shadow-none dark:border-gray-100/10 p-4 flex flex-col">
