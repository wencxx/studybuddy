<template>
    <div class="flex flex-col gap-y-10 overflow-auto">
        ...
        <div>
            ...
            <form @submit.prevent="createListing" class="grid md:grid-cols-2 gap-7">
                <div class="flex flex-col gap-y-2">
                    <label>Product Name</label>
                    <input type="text" class="w-full h-8 rounded border border-gray-300 dark:border-gray-100/10 dark:bg-transparent focus:outline-none pl-2" v-model="productData.productName">
                </div>
                <div class="flex flex-col gap-y-2">
                    <label>Product Description</label>
                    <textarea type="text" class="w-full min-h-8 rounded border border-gray-300 dark:border-gray-100/10 dark:bg-transparent focus:outline-none p-2" v-model="productData.productDescription"></textarea>
                </div>
                <div class="flex flex-col gap-y-2">
                    <label>Product Price</label>
                    <input type="number" class="w-full h-8 rounded border border-gray-300 dark:border-gray-100/10 dark:bg-transparent focus:outline-none pl-2" v-model="productData.productPrice">
                </div>
                <div class="flex flex-col gap-y-2">
                    <label>Product Category</label>
                    <select v-model="productData.productCategory" class="w-full h-8 rounded border border-gray-300 dark:border-gray-100/10 dark:bg-transparent focus:outline-none pl-2 dark:text-gray-300">
                ...
                <div class="flex flex-col gap-y-2">
                    ...
                    <input type="number" class="w-full h-8 rounded border border-gray-300 dark:border-gray-100/10 dark:bg-transparent focus:outline-none pl-2" v-model="productData.productQuantity">
                </div>
                <div class="flex flex-col gap-y-2">
                    <label>Product Image <span class="text-xs">(Atleast one image)</span></label>
                    <div @click="toggleImageInput" :class="{ '!cursor-not-allowed': tempUrl.length === 3 }" class="w-full h-8 rounded border border-gray-300 dark:border-gray-100/10 dark:bg-transparent focus:outline-none pl-2 flex items-center justify-center gap-x-2 cursor-pointer">
                ...
                <div class="grid grid-cols-4 gap-x-2 col-span-2">
                ...
                <div class="flex justify-end my-5 col-span-2">
